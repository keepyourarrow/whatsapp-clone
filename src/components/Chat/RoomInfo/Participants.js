...
export const Participants = ({ participants, currentUser, createdBy }) => {
  return (
    <div className="mt-3 bg-white ">
      ...
      {/* Loop through participants here */}
            ...
            >
              ...
              {index === 0 ? (
                <span className="text-md truncate">
                  {currentUser === createdBy ? "You" : createdBy}
                </span>
              ) : (
                <span className="text-md">
                  {currentUser === participant.name ? "You" : participant.name}
                </span>
              )}
            </div>
            {index === 0 && (
